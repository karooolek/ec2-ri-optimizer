package com.sumologic.tools.costs.ec2_ri.optimizer.ri.downloader.aws

import com.amazonaws.auth.{AWSStaticCredentialsProvider, BasicAWSCredentials}
import com.amazonaws.regions.Regions
import com.amazonaws.services.ec2.AmazonEC2Client
import com.sumologic.tools.costs.ec2_ri.optimizer.ri.ReservedInstance
import com.sumologic.tools.costs.ec2_ri.optimizer.ri.downloader.RiDownloader

import scala.collection.JavaConverters._
import scala.collection.mutable.ListBuffer

class AwsReservedInstancesDownloader(awsRegion: String, awsKey: String, awsSecret: String) extends RiDownloader {
  override def download(): List[ReservedInstance] = {
